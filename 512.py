...
# Your WhatsApp channel link (kept as-is)
channel_link = "https://whatsapp.com/channel/0029VbAjFyMFXUudqKqwkN3B"

# NOTE: Key access/activation removed per request.
# (approved_keys, normalize(), first_step(), check_key() and invocation removed)

# ANSI color codes (kept in case other prints use them)
GREEN = "\033[1;32m"
RESET = "\033[0m"

# Optional: max attempts and cooldown (no longer used)
MAX_ATTEMPTS = 3
COOLDOWN_SECONDS = 8
...
print(">>> Tool starting (key check removed) <<<")
